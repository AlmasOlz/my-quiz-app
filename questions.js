    ...
    
{
    ...
    {
        question: "npq үлкен болғанда Муавр-Лаплас қолданылады. npq >= ? \n чатта жауап 10 бірақта муғалімгің тест қате",
        options: ["10", "2", "1", "5", "50"],
        correct: 0
    },
    {
        question: "Тығыздық функциясы: f(x)=1/2, 0 <= x <= 2. Интеграл арқылы орта квадраттық ауытқуын табыңыз. муғалімгің тест қате",
...
{
        question: "3 түрлі кәмпиттен 5 кәмпит алу (қайталануы мүмкін). Неше тәсіл бар? дұрыс жауабы сессия тест қате",
        options: ["21", "35", "28", "18", "15"],
        correct: 0
    },
    {
        question: "\nX={0,1,2}, \np={0.2, 0.5, 0.3}. \nM(X) табыңыз:",
        options: ["1.1", "1.3", "2", "1.5", "0.8"],
        correct: 0
    },
    {
        question: "Бернулли формуласы не қарастырады?",
        options: [
            "n тәуелсіз сынақ және екі нәтижелі оқиға",
            "Дискретті емес шамалар",
            "Бір сынақ және 10 нәтиже",
            "Көп өлшемді нормаль үлестіру",
            "Тек тәуелді оқиғалар"
        ],
        correct: 0
    },
    {
        question: "Тығыздық функциясы \nf(x)=2x, 0 ≤ x ≤ 1 \nүшін асимметрия коэффициентін alpha табыңыз: жауабы қате дұрыс жауабы белгісіз.Тестта қате  0,566 осы дұрыс жауабы болып қалады",
        options: ["0,566", "0", "-0,566", "-1", "1"],
        correct: 0
    },
    {
        question: "Тығыздық функциясы \nf(x)=2x, 0 ≤ x ≤ 1 \nүшін дисперсияны табыңыз:",
        options: ["1/18", "1/12", "1/24", "1/9", "1/6"],
        correct: 0
    },
    {
        question: "Тығыздық функциясы \nf(x)=1/2, -1 ≤ x ≤ 1 \nүшін эксцесс коэффициентін e табыңыз:",
        options: ["-1,2", "2", "0", "-0,6", "1"],
        correct: 0
    },
    {
        question: "Классикалық ықтималдық формуласы:",
        options: ["P=m/n", "P=e^{-λ}", "P=1-p", "P=λt", "P=np"],
        correct: 0
    },
    {
        question: "Толық ықтималдық формуласы қайда қолданылады?",
        options: [
            "Сенімділік есебінде",
            "Графтар теориясында",
            "Дифференциал теңдеулерде",
            "Геометриялық оптикада",
            "Интегралдау амалында"
        ],
        correct: 0
    },
    {
        question: "Тығыздық функциясы: f(x)=2x, 0 ≤ x ≤ 1. Орта квадраттық ауытқуды табыңыз:",
        options: ["0,24", "0,33", "0,41", "0,19", "0,29"],
        correct: 0
    },
    {
        question: "4 әріп (A,B,C,D) бар. Ұзындығы 5 болатын код құру керек (әріптер қайталанады). Барлық код саны:",
        options: ["4⁵", "10!", "4! / (4-5)!", "5⁴", "4!"],
        correct: 0
    },
    {
        question: "Тұрақты кездейсоқ шаманың дисперсиясы:",
        options: ["0", "анықталмайды", "-1", "1", "тұрақтыға тең"],
        correct: 0
    },
    {
        question: "n=200, p=0,4, k=90 табу ықтималдығын Муавр-Лаплас арқылы жуықтауда z мәні:",
        options: ["1.44", "2.8", "1", "0", "-1"],
        correct: 0
    },
    {
        question: "4 түрлі шардан 6 шар таңдау (қайталануға рұқсат) саны:",
        options: ["84", "126", "462", "210", "26"],
        correct: 0
    },
    {
        question: "Тығыздық функциясы: Интеграл арқылы дисперсияны табыңыз.жауабы қате дұрыс жауабы белгісіз",
        img: "images/math/new/9.png",
        options: ["0,33", "0,25", "0,50", "0,75", "1,00"],
        correct: 0
    },
    {
        question: "X={1.3}, p={0.5, 0.5}. Дисперсияны табыңыз:",
        options: ["1", "0,5", "1,25", "4", "2"],
        correct: 0
    },
    {
        question: "Шамалар: X={1, 2, 4}; p={0.2, 0.5, 0.3}. Математикалық күтім:",
        options: ["2,5", "4", "2,1", "1,5", "3"],
        correct: 0
    },
    {
        question: "Толық ықтималдық формуласы қандай жағдайда қолданылады?",
        options: [
            "Гипотезалар толық топ құраса",
            "Үздіксіз КШ",
            "Комбинаторика",
            "Тәуелсіз сынақтар",
            "Бір гипотеза"
    ...
    {
        question: "Тығыздылық функциясы: f(x)=2x, 0 ≤ x ≤ 1 математикалық күтімді табыңыз",
        options: ["⅔", "¾", "1", "½", "⅓"],
        correct: 0
    },
    {
        question: "Бернулли кездейсоқ шамасы берілген: P(X=1)=0.25, P(X=0)=0.75. Математикалық күтімді табыңыз",
        options: ["0,25", "1,0", "0,50", "0,75", "0"],
        correct: 0
    },
    {
        question: "4 қыз және 3 ұл бір қатарға отырғызылсын. Барлық орналастыру саны:",
        options: ["5040", "120", "720", "210", "144"],
        correct: 0
    },
    {
        question: "1000 сұраудың ішінде 45-і қате. Қателік ықтималдығының статистикалық бағасы:",
        options: ["0.045", "0.45", "0.0045", "0.55", "0.95"],
        correct: 0
    },
    {
        question: "6 адам шеңбер бойымен отырғызылды. Неше түрлі орналастыру мүмкін?",
        options: ["120", "360", "6", "240", "720"],
        correct: 0
    },
    {
        question: "Барлық орналасу (алмастыру) саны P(n) қай формуламен есептеледі?",
        img: "images/math/new/7.png",
        options: ["B", "E", "D", "C", "A"], // Нақты формула нұсқалары берілмеген
        correct: 0
    },
    {
        question: "Бернулли кездейсоқ шамасының математикалық күтімі:",
        img: "images/math/new/8.png",
        options: ["D", "A", "E", "C", "B"], 
        correct: 0
    },
    {
        question: "Бернулли сызбасында q қалай анықталады?",
        options: [
            "q=1-p",
            "q=p-1 ",
            "q=n-p",
    ...
    {
        question: "Кездейсоқ шама X келесі мәндерді қабылдайды: \nX: -1, 0, 2; \nP(X=x): 0.2, 0.5, 0.3. \nҮлестірімі үшін дисперсияны D(X) есептеңіз: Дұрыс жауабы жоқ годат етесіндер",
        options: [
            "1,31",
            "0,49",
            "1,09",
    ...
    },
    {
     ...
     {
        question: "Кездейсоқ шама \nX: 0, 1, 2; \nТиісті ықтималдық: 0.3, 0.4, 0.3 \nD(X) табыңыз бұл жердеде жауабы қате басқа вариант іздерсіндер",
        options: [ "0,60",
            "1,00",
    ...
    {
        question: "3 түрлі кәмпит бар. 7 кәмпит сатып алынады (бірдейлері болуы мүмкін) неше түрлі таңдау бар?",
       img: "images/math/new/11.png",
        options: ["B","C","A","D","E"],
        correct: 0
    },
    {
        question: "Тығыздық функциясы: f(x)=2x, 0 ≤ x ≤ 1. Математикалық күтімді табыңыз:",
        options: ["2/3", "1/3", "3/4", "1", "1/2"],
        correct: 0
    },
     {
        question: "Алмастыру ерекшелігі:",
        options: ["Барлық элементтер қолданылады", "Рет маңызды емес", "Тек бір элемент алынады", "Тек жұп элементтер қолданылады", "Рет маңызды"],
        correct: 0
    },
    {
        question: "Байес формуласында алымда қандай өрнек тұрады?",
       img: "images/math/new/12.png",
        options: ["B","C","A","D","E"],
        correct: 0
    },
     
     {
        question: "x -2 0 2 \np X=x 0.25 0.5 0.25 \nосы үйлестіу үшін асимметрия коэффициентін табыңыз",
        options: [ 
            "0",
            "1",
            "0,5",
     ...
     {
        question: "MATEMATИKA сөзіндегіо әріптерді неше түрлі ретпен орналастыруға болады?",
        options: [ 
            "151200 бірақ аппеляцияда қате деп тұр",
        
        ],
        correct: 0
    },
    {
        question: "6 студенттің ішінен төраға, орынбасар және хатшы таңдалады. Неше тәсіл бар?",
        options: [ 
            "120","180","20","360","60",
    ...
    {
        question: "10 спортшының ішінен 2 орынды (1-орын, 2-орын) бөлу:",
        options: [ 
            "90","20","45","100","10",
    ...
    {
        question: "10 оқушының ішінен төраға, хатшы және қазынашы сайланады. Саны:",
        options: [ 
            "720","1000","240","120","360",
        
        ],
        correct: 0
    },
    {
        question: "3 түрлі балмұздақтан 4 балмұздақ алу (қайталану мүмкін). Саны:Дұрыс жауап сессия теста қате",
        options: [ 
            "15", "35", "20", "35", "10",
    ...
    {
        question: "10 студенттің ішінен 3 студентті командаға таңдау",
        options: [ 
            "120","30", "60", "720", "10",
    ...
    {
        question: "4 цифрдан тұратын пароль (0-3, қайталану бар) саны: жауабы дұрыс теста қате Дұрыс жауап сессия теста қате",
        options: [ 
            "256","128", "64", "512", "16",
    ...
    {
        question: "4 түрлі жалаушаны қатар ілу неше тәсілмен орындалады?",
        options: [ 
            "24","8", "4", "16", "12",
    ...
    {
        question: "Муавр-Лаплас теоремасы қай үлестіруді жуықтайды?",
        options: [ 
            "Биномдық","Геометриялық", "Бірқалыпты", "Пуассон", "Экспоненциал",
        
        ],
        correct: 0
    },
    {
        question: "Сайтқа кіру кезінде қате шығу ықтималдығы 0.03. 40 кірудің ішінде дәл 2 қате болу ықтималдығы:",
        img: "images/math/new/13.png",
        options: ["A","B","C","D","E"],
        
        correct: 0
    },
    {
        question: "Кездейсоқ шама \nX: 1, 2, 3, 4; \np: 0.1, 0.2, 0.3, 0.4. \nБерілген үлестірім үшін екінші ретті бастапқы моментті m2 = M(X²) табыңыз. қате вариант бірақ жауап дұрысы",
        options: [ 
            "10","12", "8", "9", "10",
    ...
    {
        question: "Қайталанбайтын алмастырудың формуласы:Дұрыс жауап сессия теста қате",
        img: "images/math/new/14.png",
        options: ["B","C","A","D","E"],
        correct: 0
    },
    {
        question: "Байес формуласында алымда қандай көбейтінді тұрады?",
        img: "images/math/new/15.png",
        options: ["B","C","A","D","E"],
        correct: 0
    },
    {
        question: "n=25, p=0.4. Ең ықтимал табыстар саны (мода):Дұрыс жауап сессия теста қате ",
        options: [ 
            "10","12", "7", "8", "9",
    ...
    {
        question: "\"Үш сигма\" ережесі нені көрсетеді?",
        options: [ 
            "68%, 95%, 99.7% қамту аймағы ","Ықтималдық нөлге тең",
             "Дисперсия нөл", 
             "100% үлестіру диапазоны",
              "Медиана σ-ға тең",
    ...
    {
        question: "Кездейсоқ шама X барлық мәндерді бірдей ықтималдықпен қабылдайды:Х={1, 2, 3, 4} σ=?",
        options: [ 
            "1.12","1.25", "1.00", "0.90", "1.50",
        
        ],
        correct: 0
    },
    {
        question: "9 адамнан 3 адамды ретімен таңдау саны:",
        options: [ 
            "504","362", "720", "216", "84",
    ...
    {
        question: " 4 түрлі әріптен 6 әріптік сөз құрылады (қайталануға болады). Саны:",
        options: [ 
            "4096","24", "256", "64", "1024",
    ...
    {
        question: "12 студенттің ішінен 5 студентті топқа таңдау саны: ",
        options: [ 
            "792 ","95040 ", "720 ", "495 ", "240",
    ...
    {
        question: "Тығыздық функциясы: Интеграл арқылы математикалық күтімді табыңыз. ",
         img: "images/math/new/19.png",
        options: [ 
            "1.0","1.5", "0.25", "0.25", "2.0",
        
        ],
        correct: 0
    },
    {
        question: "[0;10] аралығынан кездейсоқ нүкте таңдалды. Ол [3;7] аралығына түсу ықтималдығы:Дұрыс жауап сессия теста қате ",
        options: [ 
            "0.4","0.7", "0.3", "0.2", "0.1",
    ...
    {
        question: "8 студенттің ішінен 4 студентті таңдау саны: Дұрыс жауап сессия теста қате ",
        options: [ 
            "70","1680", "210", "35", "40",
    ...
    {
        question: "Қайталанатын орналастыру формуласы: ",
        img: "images/math/new/20.png",
        options: ["C","B","A","D","E"],
        correct: 0
    },
